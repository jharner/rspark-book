...
$$ x - \frac{f(x)}{Df(x)}$$
where $Df$ denotes the derivative of $f$. The algorithm for finding the root of a differential function illustrates many principles of functional programming. The implementation used here is based on Tierney's List-Stat implementaion (Tierney, 1990).
