...
`sparklyr` provides support to run arbitrary R code at scale within your Spark through the function `spark_apply`. Thus, any of R's functionality can be distributed across an R cluster.  Apache Spark, even with Spark Packages, has a limited range of functions available.
...
### 6.4.1 Apply an R function to a Spark Object
