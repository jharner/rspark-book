...
* *MLlib* for machine learning, including classification, regression, clustering, collaborative filtering, dimensionality reduction, and the underlying optimization alogorithms. MLlib uses the DataFrame API and thus takes advantage of the Sprak SQL engine.
