...
Put another way, supervised learning is concerned with problems that have a measurable (or labeled) output (response) variable and unsupervised learning is concerned with problems without a output variable.
