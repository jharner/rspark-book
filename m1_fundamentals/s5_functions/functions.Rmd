...
Material in this section is based partially on Hadley's Wickham's [Advanced R Functions](http://adv-r.had.co.nz/Functions.html).
...
Hadley Wickham has an in depth discussion of closures, functionals, and function operators in [Advanced R Functional Programming](http://adv-r.had.co.nz/Functional-programming.html). The following example illustrates many of the concepts in functional programming.
